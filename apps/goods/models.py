...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(default="", max_length=30, verbose_name="类别名", help_text="类别名")  # help_text：帮助文档
    code = models.CharField(default="", max_length=30, verbose_name="类别code", help_text="类别名")
    desc = models.TextField(default="", verbose_name="类别描述", help_text="类别名")
    # 分类级别
